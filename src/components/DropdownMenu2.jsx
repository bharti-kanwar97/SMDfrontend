...
const [subMenu, setSubMenu] = useState(false)
  return (
    ...
    <>
  { open && <div className='sideMenu flex flex-col fixed w-full lg:top-[40px] sm:top-[95px] top-[58px] shadow-xl/45 left-0 bg-white px-12 py-4 sm:py-5 lg:py-8 z-2 block lg:hidden max-h-fit overflow-y-auto'>
