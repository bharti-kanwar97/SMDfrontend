...
const [subMenu, setSubMenu] = useState(false)
  ...
  { open && <div className='sideMenu flex flex-col fixed w-full lg:top-[40px] sm:top-[95px] top-[58px] shadow-xl/45 left-0 bg-white px-12 py-4 sm:py-5 lg:py-8 z-2 block lg:hidden'>
      <ul className='flex flex-col gap-4'> 
        ...
        <li className='font-sans font-normal text-[#888] text-[16px] text-left pt-[16px] leading-[18px] '  onClick={() => {setOpen(true); setSubMenu(prev => !prev) }}>Course <IoMdArrowDropdown className="inline-block" />
