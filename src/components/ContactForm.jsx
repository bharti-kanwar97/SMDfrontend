  ...
  return (
    <div className="w-[100%] mx-auto bg-white rounded-md h-auto">
      ...
      <form onSubmit={handleSubmit} className="w-[90%] mx-auto">
        ...
        <br />
        <select name="about" id="" className={`border-b-1 md:border-2  border-zinc-400 px-0.5 md:px-4 py-1 md:py-2 md:rounded-md bg-white  w-full md:mt-4 lg:mt-3 sm:mt-2.5 mt-1.5  ${formData.about === "" ? "text-zinc-500" : "text-black"}`} value={formData.about}
          onChange={handleChange}
         >
          <option value="" className="text-zinc-500" disabled>Select Course...</option>
