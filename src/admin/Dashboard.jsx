  ...
  return (
    <>
      <div className="h-screen flex flex-col ">
        ...
        <Header />
        <div className="flex flex-1 overflow-hidden gap-8 bg-[#EDE8D0] ">
          <div className="w-[30%] h-full overflow-y-auto">
            <SideNav />
          </div>
          <div className="w-full bg-[#EDE8D0] px-10 py-10 flex-1 h-full overflow-y-auto">
            <div className="flex gap-5 justify-left mt-10 ">
